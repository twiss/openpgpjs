 ...
 * @param  {String} userId             (optional) user ID to encrypt for, e.g. 'Robert Receiver <robert@openpgp.org>'
 ...
 * @param  {String} userId                (optional) user ID to sign with, e.g. 'Steve Sender <steve@openpgp.org>'
