...
import { saltLengthForHash } from './signature';
...
class OnePassSignaturePacket {
  ...
  /**
   * Sets the internal salt to a new randomly generated
   * salt with the length derived from the field hashAlgorithm.
   * @throws {Error} if salt generation failed
   * @async
   */
  async generateSalt() {
